...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 lg:py-20 md:gap-28 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <div className="flex flex-wrap my-11 gap-5">
          ...
          <p className="text-blue-70 bold-16 lg:bold-20">
            198K
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative flex z-20 w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <div className="flex flex-col">
            ...
            <p className="bold-20 text-white">Aguas cliantes</p>
          </div>
